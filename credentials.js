...
let CredentialHandler = {
    ...
    modify:(topic)=>{
        let questions = [
            {type:'list',name:'choice',message:'Which property do you want to edit?','choices':CredentialHandler.propertyOptions},
            {type:'input',name:'name',message:'Name of property',when:(answer)=>{return answer.choice === 'create new'}},
